...
import spiral from "../../../../../public/icons/circle.png";
import Image from "next/image";
import Doc from "../../../../../public/icons/336d8e1819c7512cca52d33ab385dfa4.jpeg";
import im3 from "../../../../../public/icons/ion_call-outline.png";
import insta from "../../../../../public/icons/Group (2).png";
import fb from "../../../../../public/icons/logos_facebook.png";
import tick from "../../../../../public/icons/tick.png";
import thumb from "../../../../../public/icons/tabler_thumb-up.png";
...
const DoctorDetails = ({ params }) => {
  const arr = doc.doctors.find((item) => item.id === params.doctorId);
  return (
    <>
        ...
        <div>
            ...
            <div className="bg-[#FFFFFF]  max-[581px]:h-[495px] w-[850px] h-[390px] relative top-8  mb-[50px] rounded-[55px] max-[848px]:w-[727px] max-[760px]:w-[669px] max-[669px]:w-[587px]">
              <div className="flex w-[100%]  items-center justify-center gap-5 pt-6 mb-4">
                ...
                <div className="bg-gradient-to-r from-[#00FFF6] to-[#0080FF] h-[42px] w-[104px] rounded-xl flex justify-center items-center gap-3 text-white">
                  <Image src={star} alt="img" height={30} width={30}></Image>
                  <span>5.0</span>
                </div>
                <div>
                  <Image src={spiral} alt="img" height={40} width={40}></Image>
                </div>
              </div>
          ...
          <div className="max-[1200px]:w-[100%] max-[1200px]:justify-center max-[1200px]:items-center max-[1200px]:flex max-[1200px]:flex-col">
            <div className="h-[1000px] bg-[#FFFFFF] rounded-[55px] w-[834px] max-[848px]:w-[604px] ">
              ...
              <div className="px-[35px] max-[577px]:flex max-[577px]:flex-col max-[577px]:justify-center max-[577px]:items-center max-[577px]:mt-16">
                ...
                <div className=" flex w-[269px] text-[22px] h-[32px] rounded-2xl text-white bg-gradient-to-r from-[#00D7CF] to-[#017BFC]">
                  <div className="px-2 pt-[5px]">
                    <Image alt="img" src={im3} height={20} width={20}></Image>
                  </div>
                  +91 12345 67890
                </div>
                <div className="flex gap-3 pt-[18px] pl-3">
                  <Image alt="img" src={insta} height={28} width={28}></Image>
                  <Image alt="img" src={fb} height={28} width={28}></Image>
                </div>
              </div>
              ...
              <div className="px-[35px] max-[577px]:flex max-[577px]:flex-col max-[577px]:justify-center max-[577px]:items-center max-[577px]:mt-5 max-[577px]:mb-5 mt-16">
      ...
      <Dialog className="rounded-[50px]">
        ...
        <DialogContent className="sm:max-w-[665px] h-56 ">
          ...
          <div className="flex justify-around">
            ...
            <button className="w-[180px] max-[400px]:mt-2 text-2xl  h-12 border-2 border-black rounded-3xl hover:bg-[#1FBB00] hover:border-0 hover:text-white">
              Yes
            </button>
          </div>
        </DialogContent>
