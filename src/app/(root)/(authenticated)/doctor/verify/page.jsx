  ...
  return (
    ...
    <div className="h-screen w-screen bg-gradient-to-b from-[#B2D9FF] to-[#0080FF] ">
      ...
      <div className='z-0 hidden lg:block'>
        ...
        <img className='fixed h-[200px] top-[500px] left-[390px]' src='/mainpage/maki_doctor.png'></img>
        <img className='fixed h-[160px] top-[500px] left-[280px]'  src='/mainpage/Ellipse 69.png'></img>
        <img className='fixed h-[90px] left-[22px] top-[390px]' src='/mainpage/Ellipse 70.png'></img>
        <img className='h-[130px] fixed left-[320px] top-[130px]' src='/mainpage/Ellipse 71.png'></img>
        <img className='fixed left-[480px] top-[20px]' src='/mainpage/Ellipse 72.png'></img>
        <img className='h-[150px] fixed left-[350px] top-[-50px]' src='/mainpage/fluent_doctor-28-regular.png'></img>
        <img className='fixed left-[-15px] h-[130px] top-[150px]' src='/mainpage/fluent_doctor-48-filled.png'></img>
        <img  className='fixed left-[250px] top-[200px]'src='/mainpage/Vector.png'></img>
    
    
        <div className="absolute">
            <img src='/mainpage/Logo.png' className="h-[100px]"></img>
        </div>   
      ...
      <div className="w-full h-full flex flex-col justify-end lg:flex-row z-10">
        ...
        <div className="lg:w-[40%] h-full hidden lg:flex flex-col items-center justify-center space-y-6 p-6">
          <p className="z-10 text-[40px] md:text-[60px] lg:text-[75px] font-nunito font-bold text-white text-center">
            Welcome Back!
          </p>
          <p className="z-10 text-[18px] md:text-[24px] lg:text-[30px] font-[700px] font-nunito text-white text-center">
